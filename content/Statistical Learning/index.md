...
description: Part 1 of STAT615 — prediction, Bayes classifiers, local averaging, concentration, and consistency.
aliases:
  - STAT615
...
Notes from **UW-Madison STAT615, Spring 2026**, organized in lecture order. Repeated recaps are combined; assumptions, intermediate calculations, and conclusions stay together. Mathematical corrections are identified where they occur.

Source: [STAT615 lecture PDF](615.pdf). These four parts cover all 24 lectures:

| Part                                                    | Content                                                              | Lectures and PDF pages                                                             |
| ------------------------------------------------------- | -------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| **1. This page**                                        | Prediction, Bayes rules, local averaging, concentration, consistency | 0-9; pp. 6-31                                                                      |
| [[2 Empirical Risk and Generalization                   | 2. Empirical risk and generalization]]                               | ERM, uniform convergence, VC theory, Rademacher complexity                         | 9-13; pp. 31-46  |
| [[3 Linear Classifiers and Support Vector Machines      | 3. Linear classifiers and SVMs]]                                     | LDA, QDA, logistic regression, margins, duality, feature maps                      | 13-17; pp. 47-63 |
| [[4 Kernels Gaussian Processes and Conformal Prediction | 4. Kernels, Gaussian processes, and conformal prediction]]           | RKHS, representer theorem, kernel regression, spectral expansions, prediction sets | 17-23; pp. 63-90 |
